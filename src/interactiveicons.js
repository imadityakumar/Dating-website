...
import tickmark from './pages/images/72421-tickmark.gif';
import reels from './pages/images/90543-reel-to-reel.gif';
import hello from './pages/images/71481-hello-handsome.gif';
import peoplephone from './pages/images/76957-using-phone.gif'
...
function Interactiveicons() {
    return (
        <div className='maindiv'>
            <br />
            <div className='div1'>
                <img className='tick' src={tickmark}></img>
                <h4>
